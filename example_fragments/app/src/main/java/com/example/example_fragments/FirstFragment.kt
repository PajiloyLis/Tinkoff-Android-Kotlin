package com.example.example_fragments

import android.os.Bundle
import android.view.View
import android.widget.Toast
import androidx.fragment.app.Fragment
import com.example.example_fragments.databinding.FragmentFirstBinding
...
class FirstFragment : Fragment(R.layout.fragment_first) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        parentFragmentManager.setFragmentResultListener(
            RESULT_REQUEST_KEY,
            this
        ) { key, bundle -> handleResult(bundle) }
    }
    ...
    private fun navigate() {
        ...
        parentFragmentManager.beginTransaction()
            .replace(R.id.frameContainer, SecondFragment.newInstance(data, RESULT_REQUEST_KEY, RESULT_DATA_KEY))
            .addToBackStack(null)
            .commit()
    }
