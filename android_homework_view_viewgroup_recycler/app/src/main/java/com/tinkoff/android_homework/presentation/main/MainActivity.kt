...
import com.tinkoff.android_homework.presentation.main.adapter.OperationsAdapter
...
class MainActivity : AppCompatActivity() {
    ...
    private fun subscribeToOperations() {
        lifecycleScope.launch {
            viewModel.operations.collect {operationsList ->
                (operationsRecyclerView.adapter as OperationsAdapter).data = operationsList
            }
        }
    }
